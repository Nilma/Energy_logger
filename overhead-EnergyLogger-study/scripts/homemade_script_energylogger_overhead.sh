...
do
	...
	# idle with no logging
	send_start "0.0" # -- start the siglent ---
	sleep "80" 
	send_stop "0.0" # -- stop the siglent ---
	...
	OUTFILE="pmic_log_${SAMPLEPERIOD}s_${TS}.csv"  # CSV output in timestamped filename
